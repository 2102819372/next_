  ...
  const videos = [
    {
      ...
      title: "Frames",
      source: "/assets/videos/top_2.mp4",
      subTitle: (
        <div className="mt-auto">
          Lorem ipsum, dolor sit amet consectetur
          <br className="hidden lg:block" />
          adipisicing elit. Dolorum, qui.
        </div>
      ),
    },
    {
      source: "/assets/videos/top_1.mp4",
      title: "Gen-3 Alpha",
      href: "/research/introducing-gen-3-alpha",
      subTitle: (
        <div className="mt-auto ">
          iste sunt dolore illo minus aliquam volupt
          <br className="hidden lg:block" />
          atibus laborum molestiae nobis vitae!
        </div>
      ),
    },
  ];
  return (
    <>
      ...
      <div className="absolute bottom-5 lg:bottom-10 left-5 lg:left-9 z-10">
        <div className="mb-4">New releases</div>
        <div
          ...
          {videos.map((videoIndex, idx) => {
            return (
              <div key={idx} className="relative">
                <Link
                  className={`!leading-[.9] cursor-pointer transition-all duration-300 hover:text-white text-[#EFEEE6]/60 rw-h2 ${
